...
class ICL_HG38Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.variable_length:
            ...
            seq = self.tokenizer(
                seq, add_special_tokens=False, max_length=self.pad_max_length
            )
        ...
        cls_token = self.tokenizer._vocab_str_to_int.get(
            chr_name, self.tokenizer._vocab_str_to_int["[UNK]"]
        )
